...
- What I changed before committing: mainly syntax differences, sometimes a line of code, rarely would I use its entire loop
- How I verified correctness: matching outputs with Rosalind's sample solution
